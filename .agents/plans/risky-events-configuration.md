...
- [ ] Админ может создавать/редактировать глобальные risky события
- [ ] При создании risky конкурса можно выбрать до 10 событий из базы
- [ ] Для каждого выбранного события можно изменить очки
- [ ] Для конкретного матча можно переопределить события и очки
- [ ] Бот показывает правильные события и очки для каждого матча
- [ ] Очки начисляются корректно с учётом всех переопределений
